# Geni-eg
Data ***Gen***eration ***i***nfrastructure for ***e***Plus and ***g***IS
...
- 따라서, Geni-eg는 GIS 데이터와 Eplus 엔진을 기반하여,
...
# Copyright
Data ***Gen***eration ***i***nfrastructure for ***e***Plus and ***g***IS in South Korea Copyright (c) 2023
